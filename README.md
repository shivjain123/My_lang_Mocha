🌱 Origin & Philosophy
Disclaimer: Mocha is not a copy of Brendan's language, the JS/Node framework, or any other known framework. It is not a web language. It is a compiled, statically-typed, scientific computing language — Julia's cousin, not JavaScript's descendant.
In 1995, Brendan Eich named his new language Mocha at Netscape — before marketing pressure renamed it LiveScript, then JavaScript. He built the first version in ten days to meet a browser release deadline, under orders to make it look like Java. The name Mocha was discarded. This language reclaims it.
